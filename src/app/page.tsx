        ...
        <div className="container mx-auto flex flex-col gap-16 px-6 py-24 md:flex-row md:items-center">
          <div className="w-full md:w-1/2">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                href="/founders"
                className="inline-flex items-center justify-center rounded-lg border border-gray-300 px-6 py-3 text-base font-medium text-gray-900 transition hover:bg-gray-100"
              >
                Meet the founders
              </Link>
            </div>
          ...
          <div className="relative w-full md:w-1/2">
            <div className="aspect-[4/3] overflow-hidden rounded-3xl bg-white shadow-lg">
              <img
            ...
            <div className="absolute -bottom-6 -right-4 hidden rounded-2xl bg-white p-4 shadow-lg md:block">
